...
public class Recipe implements NutritionalElement {
	...
	public String toString() {
		...
		for(NutritionalElement ne : keys) {
			Double qta=ingredients.get(ne);
			sb.append(ne.getName()).append(" : ").append(qta).append("\n");
		}
		return sb.toString();
	}
}
