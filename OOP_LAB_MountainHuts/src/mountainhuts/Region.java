	...
	public Map<String, Map<String, Long>> countMountainHutsPerMunicipalityPerProvince() {
		return mountainHut.values().stream()
				...
				.collect(Collectors.groupingBy(	MountainHut::getProvince,
												TreeMap::new,
												Collectors.groupingBy(	MountainHut::getMunicipalityName,
																		TreeMap::new,
																		Collectors.counting()
																		)
												)
...
//						if(this.getAltitudeRange(OAltitude.get()).equals("0-INF"))
//							return false;
//					if(this.getAltitudeRange(m.getMunicipality().getAltitude()).equals("0-INF"))
//						return false;
//					return true;
//				} ).
