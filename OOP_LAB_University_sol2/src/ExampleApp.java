...
public class ExampleApp {
	...
	public static void main(String[] args) throws UniversityException {
		...
		try {
			...
			System.out.println("s1 = " + poli.student(0)); // 0 non valido
			System.out.println("Questa stampa non verrà mai eseguita, perchè 0 causa un'eccezione!");
		}catch(UniversityException e) {
			System.err.println("Errore nel recuperare lo studente: " + e.getMessage());
		}finally {
			System.out.println("Comunque sia questa stampa viene eseguita, anche se ci sono altre eccezioni");
		}
		
		System.out.println("Comunque sia questa stampa viene eseguita salvo altre eccezioni");
